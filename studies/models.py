...
class StudyPlan(models.Model):
    ...
    plan_content = models.JSONField(help_text="Estrutura semanal do plano de estudos in JSON")
...
class ChallengeSubmission(models.Model):
    ...
    execution_output = models.TextField(blank=True, null=True, help_text="Saída do console de execução de testes")
    feedback = models.TextField(blank=True, null=True, help_text="Feedback da IA analisando o código, PEP8 e sugestões")
    created_at = models.DateTimeField(auto_now_add=True)
